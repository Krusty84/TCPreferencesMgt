...
/*
 ...
 final class TCConnection {
     ...
     var url: String
     var username: String
     var password: String   // NOTE: plain string, not Keychain
     var comment: String?   // optional user note about connection
     ...
     // Relationship: a connection owns collections
     @Relationship(deleteRule: .cascade, inverse: \TCCollection.connection)
     var collections: [TCCollection] = []
